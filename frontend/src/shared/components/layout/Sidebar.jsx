    ...
    >
      ...
      {isExpanded && (
        <div className="mx-4 my-2 p-3 bg-slate-50 dark:bg-slate-800/40 border border-slate-100 dark:border-slate-850 rounded-2xl text-left">
          <span className="text-[9px] font-black uppercase tracking-[0.2em] text-slate-450 dark:text-slate-400 block mb-1">Current Scope</span>
          ...
          {activeLabel && (
            <p className="text-[9px] font-bold text-slate-450 mt-1 truncate">
