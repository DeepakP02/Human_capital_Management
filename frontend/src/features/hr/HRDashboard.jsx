...
const HRDashboard = () => {
  ...
  const stats = [
    { label: 'Open Jobs', value: openJobsCount, trend: `+${jobs.reduce((a,b)=>a+(b.new||0),0)} new this week`, icon: Briefcase, color: 'blue', bg: 'bg-blue-50 dark:bg-blue-950/20', iconColor: 'text-blue-600 dark:text-blue-450', trendColor: 'text-blue-500 dark:text-blue-400' },
    { label: 'New Applicants', value: candidates.length, trend: `+${newApplicants} since last week`, icon: Users, color: 'purple', bg: 'bg-purple-50 dark:bg-purple-950/20', iconColor: 'text-purple-600 dark:text-purple-450', trendColor: 'text-purple-500 dark:text-purple-400' },
    { label: 'Interviews Today', value: todayInterviewsCount, trend: '2 starting soon', icon: CalendarCheck, color: 'green', bg: 'bg-emerald-50 dark:bg-emerald-950/20', iconColor: 'text-emerald-600 dark:text-emerald-450', trendColor: 'text-emerald-500 dark:text-emerald-450' },
    { label: 'Hires This Month', value: candidates.filter(c=>c.stage==='Hired').length, trend: '+2 vs last month', icon: BadgeCheck, color: 'orange', bg: 'bg-orange-50 dark:bg-orange-950/20', iconColor: 'text-orange-600 dark:text-orange-450', trendColor: 'text-orange-500 dark:text-orange-400' },
  ];
                       ...
                       {recentApplicants.map((app, i) => (
                          <tr key={i} className="hcm-tr">
                             ...
                             <td className="hcm-td text-right">
                                <button className="p-2 text-slate-400 hover:text-primary-600 dark:hover:text-primary-400 rounded-lg transition-all">
        ...
        <div className="lg:col-span-4 space-y-8">
                    ...
                    <div key={i} className="p-4 bg-slate-50 dark:bg-slate-800/30 rounded-2xl border border-slate-100 dark:border-slate-800 hover:border-primary-100 dark:hover:border-primary-900 transition-all group">
                       <div className="flex items-center gap-4 mb-4">
                          ...
                          <div className="flex-1">
                             ...
                             <p className="text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest">{int.role}</p>
                          </div>
                       ...
                       <div className="flex items-center justify-between pt-4 border-t border-slate-100 dark:border-slate-800">
                          ...
                          <button onClick={() => showToast('Opening meeting interface...')} className="btn-secondary text-[10px] flex items-center gap-2 py-1.5 px-3">
                             <Video size={14} />
                             <span>Join Link</span>
                          </button>
                       </div>
           ...
           <div className="card bg-gradient-to-br from-indigo-50/50 to-white dark:from-indigo-950/10 dark:to-slate-900 group">
              ...
              <div className="space-y-6">
                 <div>
                    <div className="flex justify-between items-center mb-2">
                       ...
                       <p className="text-sm font-extrabold text-indigo-600 dark:text-indigo-400">92%</p>
                    </div>
                 ...
                 <div>
                    <div className="flex justify-between items-center mb-2">
                       <p className="text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest">Time to Hire</p>
                       <p className="text-sm font-extrabold text-indigo-600 dark:text-indigo-400">18 Days</p>
                    </div>
                    <div className="w-full h-2 bg-white dark:bg-slate-800 rounded-full overflow-hidden shadow-inner border border-slate-100 dark:border-slate-850">
              ...
              <div className="mt-8 pt-6 border-t border-indigo-100/30 dark:border-slate-800 flex items-center justify-between">
                 ...
                 <button className="p-1.5 hover:bg-white dark:hover:bg-slate-800 rounded-lg transition-all">
