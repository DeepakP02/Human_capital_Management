...
const Settings = () => {
  ...
  const [tempLanguage, setTempLanguage] = useState(appSettings?.general?.language || 'English (US) - Primary');

  const handleSave = () => {
    updateSettings('general', { language: tempLanguage });
                  ...
                  <div className="card p-10  space-y-10">
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                        <div className="space-y-2">
                           ...
                           <select value={tempLanguage} onChange={e => setTempLanguage(e.target.value)} className="input-field h-14 bg-slate-50 border-transparent font-bold text-slate-700 notranslate">
                        ...
                        <div className="space-y-2">
                           ...
                           <div className="relative">
                              ...
                              <select value={appSettings.general.timezone} onChange={e => updateSettings('general', { timezone: e.target.value })} className="input-field h-14 pl-12 bg-slate-50 border-transparent font-bold text-slate-700 notranslate">
                        ...
                        <div className="space-y-2">
                           ...
                           <select value={appSettings.general.dateFormat} onChange={e => updateSettings('general', { dateFormat: e.target.value })} className="input-field h-14 bg-slate-50 border-transparent font-bold text-slate-700 notranslate">
                        ...
                        <div className="space-y-2">
                           ...
                           <select value={appSettings.general.defaultCurrency || 'USD ($) - US Dollar'} onChange={e => updateSettings('general', { defaultCurrency: e.target.value })} className="input-field h-14 bg-slate-50 border-transparent font-bold text-slate-700 notranslate">
