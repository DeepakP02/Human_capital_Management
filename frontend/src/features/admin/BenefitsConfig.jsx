...
const BenefitsConfig = () => {
  ...
  const stats = [
    ...
    { label: 'Active Enrollees', value: activeEnrollees, icon: Users, color: 'text-indigo-600 dark:text-indigo-400', bg: 'bg-indigo-50 dark:bg-indigo-950/30' },
    { label: 'Total Contribution', value: '$84K', icon: DollarSign, color: 'text-emerald-600 dark:text-emerald-400', bg: 'bg-emerald-50 dark:bg-emerald-950/30' },
  ];
            ...
            <table className="hcm-table">
               <thead className="hcm-thead">
                  <tr>
                     ...
                     <th className="hcm-th text-center">Category</th>
                     <th className="hcm-th text-center">Provider</th>
                     <th className="hcm-th text-center">Eligibility</th>
                     <th className="hcm-th text-center">Employer Contribution</th>
               ...
               <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                  {filteredBenefits.length > 0 ? filteredBenefits.map((plan) => (
                     <tr key={plan.id} className="hcm-tr">
                        ...
                        <td className="hcm-td text-center font-black text-slate-900 dark:text-white">{plan.contribution}</td>
                        <td className="hcm-td text-center">
                           <span className={cn(
