...
const ApplicationForm = () => {
 ...
 <h2 className="text-4xl font-medium text-slate-900 mb-4 tracking-tight uppercase leading-none">PAYLOAD DISPATCHED</h2>
 ...
 <button 
 onClick={() => navigate(-1)}
 className="w-14 h-14 rounded-xl bg-slate-50 border border-slate-100 text-slate-400 hover:text-primary-600 transition-all flex items-center justify-center shadow-sm"
 >
 <ArrowLeft size={24} />
 </button>
 <div>
 <h1 className="text-4xl font-medium text-slate-900 tracking-tight uppercase leading-none mb-2">ENGAGEMENT PROTOCOL</h1>
 <p className="text-slate-400 font-medium tracking-tight uppercase text-sm">Phased submission for <span className="text-slate-900 font-medium">{jobInfo.title}</span></p>
 </div>
 </div>
 </div>
 ...
 <h3 className="text-2xl font-medium text-slate-900 tracking-tight uppercase">Identity Node</h3>
 </div>
 
 <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
 <div className="space-y-3 group">
 <label className="text-[10px] font-medium text-slate-400 uppercase tracking-[0.3em] ml-1 group-focus-within:text-primary-600 transition-colors uppercase">Full Engagement Name</label>
 <div className="relative">
 <User className="absolute left-5 top-5 text-slate-200 group-focus-within:text-primary-500 transition-colors" size={18} />
 <input type="text" value={formData.fullName} onChange={e => setFormData({...formData, fullName: e.target.value})} required className="input-field pl-14 h-14 bg-slate-50 border-transparent font-medium" />
 </div>
 </div>
 <div className="space-y-3 group">
 <label className="text-[10px] font-medium text-slate-400 uppercase tracking-[0.3em] ml-1 group-focus-within:text-primary-600 transition-colors uppercase">Digital Interface (Email)</label>
 <div className="relative">
 <Mail className="absolute left-5 top-5 text-slate-200 group-focus-within:text-primary-500 transition-colors" size={18} />
 <input type="email" value={formData.email} onChange={e => setFormData({...formData, email: e.target.value})} required className="input-field pl-14 h-14 bg-slate-50 border-transparent font-medium" />
 </div>
 </div>
 <div className="space-y-3 group">
 <label className="text-[10px] font-medium text-slate-400 uppercase tracking-[0.3em] ml-1 group-focus-within:text-primary-600 transition-colors uppercase">Voice Comms Line</label>
 <div className="relative">
 <Phone className="absolute left-5 top-5 text-slate-200 group-focus-within:text-primary-500 transition-colors" size={18} />
 <input type="tel" value={formData.phone} onChange={e => setFormData({...formData, phone: e.target.value})} required className="input-field pl-14 h-14 bg-slate-50 border-transparent font-medium" />
 </div>
 </div>
 <div className="space-y-3 group">
 <label className="text-[10px] font-medium text-slate-400 uppercase tracking-[0.3em] ml-1 group-focus-within:text-primary-600 transition-colors uppercase">Operational Hub (Loc)</label>
 <div className="relative">
 <MapPin className="absolute left-5 top-5 text-slate-200 group-focus-within:text-primary-500 transition-colors" size={18} />
 <input type="text" value={formData.location} onChange={e => setFormData({...formData, location: e.target.value})} className="input-field pl-14 h-14 bg-slate-50 border-transparent font-medium" />
 </div>
 </div>
 </div>
 </section>
 ...
 <h3 className="text-2xl font-medium text-slate-900 tracking-tight uppercase">Strategic Artifacts</h3>
 </div>

 <div className="space-y-4">
 <label className="text-[10px] font-medium text-slate-400 uppercase tracking-[0.3em] ml-1 uppercase">Payload Submission (Resume)</label>
 <div 
 className={cn(
 ...
 <div className="flex items-center gap-6">
 <div className="w-20 h-20 rounded-2xl bg-white flex items-center justify-center text-emerald-600 shadow-xl group-hover:rotate-6 transition-transform">
 <FileText size={36} />
 </div>
 <div className="text-left">
 <p className="text-lg font-medium text-slate-900 uppercase tracking-tight">{resume.name}</p>
 <p className="text-[10px] font-medium text-slate-400 mt-2 uppercase tracking-[0.3em]">{resume.size} • SYNC READY</p>
 </div>
 </div>
 ...
 <p className="text-2xl font-medium text-slate-900 uppercase tracking-tight mb-2">Transmit Registry Artifact</p>
 <p className="text-[10px] font-medium text-slate-300 uppercase tracking-[0.4em]">PDF / DOCX (MAX 5MB)</p>
 </div>
 )}
 </div>
 </div>
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
 <div className="space-y-3 group">
 <label className="text-[10px] font-medium text-slate-400 uppercase tracking-[0.3em] ml-1 group-focus-within:text-primary-600 transition-colors uppercase">Skill Matrix Coverage</label>
 ...
 className="flex-1 bg-transparent border-none outline-none text-sm font-medium text-slate-900 uppercase"
 />
 </div>
 </div>
 <div className="space-y-3 group">
 <label className="text-[10px] font-medium text-slate-400 uppercase tracking-[0.3em] ml-1 group-focus-within:text-primary-600 transition-colors uppercase">Comp. Expectation</label>
 <div className="relative">
 <DollarSign className="absolute left-5 top-5 text-slate-200 group-focus-within:text-primary-500 transition-colors" size={18} />
 <input type="text" value={formData.expectedSalary} onChange={e => setFormData({...formData, expectedSalary: e.target.value})} placeholder="$145,000" className="input-field pl-14 h-14 bg-slate-50 border-transparent font-medium" />
 </div>
 </div>
 </div>
 </section>
 ...
 <h3 className="text-2xl font-medium text-slate-900 tracking-tight uppercase">Strategic Comms</h3>
 </div>

 <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
 <div className="space-y-3 group">
 <label className="text-[10px] font-medium text-slate-400 uppercase tracking-[0.3em] ml-1 uppercase">LinkedIn Node</label>
 <div className="relative">
 <Globe className="absolute left-5 top-5 text-slate-200" size={18} />
 <input type="url" value={formData.linkedin} onChange={e => setFormData({...formData, linkedin: e.target.value})} placeholder="https://linkedin.com/..." className="input-field pl-14 h-14 bg-slate-50 border-transparent font-medium" />
 </div>
 </div>
 <div className="space-y-3 group">
 <label className="text-[10px] font-medium text-slate-400 uppercase tracking-[0.3em] ml-1 uppercase">Artifact Portfolio</label>
 <div className="relative">
 <LinkIcon className="absolute left-5 top-5 text-slate-200" size={18} />
 <input type="url" value={formData.portfolio} onChange={e => setFormData({...formData, portfolio: e.target.value})} placeholder="https://dossier.design" className="input-field pl-14 h-14 bg-slate-50 border-transparent font-medium" />
 </div>
 </div>
 </div>
 ...
 <label className="text-[10px] font-medium text-slate-400 uppercase tracking-[0.3em] uppercase">Operational Intent (Cover Letter)</label>
 <span className="text-[9px] font-medium text-slate-300">Phase Buffer: 2000 Units</span>
 </div>
 <textarea 
 rows={8} 
 ...
 className="input-field py-8 px-10 bg-slate-50 border-transparent resize-none font-medium text-sm leading-relaxed"
 />
 </div>
 </section>
 ...
 className="flex-3 h-20 bg-primary-600 text-white rounded-[2rem] text-sm font-medium uppercase tracking-[0.4em] shadow-2xl hover:bg-primary-700 transition-all active:scale-95 disabled:opacity-50 overflow-hidden relative group"
 >
 ...
 className="flex-1 h-20 bg-white text-slate-600 border border-slate-200 rounded-[2rem] font-medium uppercase tracking-[0.2em] text-[10px] hover:text-slate-900 transition-all border border-slate-100"
 >
 Buffer Draft
 </button>
 </div>
 ...
 <p className="text-[9px] font-medium uppercase tracking-[0.4em] text-slate-400 mb-4 leading-none">Security Clearance</p>
 ...
 <h3 className="text-[10px] font-medium text-slate-400 uppercase tracking-[0.4em] mb-10 flex items-center gap-3">
 ...
 <p className="text-[11px] font-medium text-slate-900 uppercase tracking-tight group-hover:text-primary-600 transition-colors uppercase">{tip.title}</p>
 <p className="text-[10px] font-medium text-slate-400 leading-relaxed opacity-80">{tip.desc}</p>
 </div>
 ))}
 </div>
 <button className="w-full mt-12 py-4 bg-white text-slate-600 border border-slate-200 text-[9px] font-medium rounded-xl hover:bg-primary-50 hover:text-primary-600 transition-all">Retrieve Full Guide</button>
 </div>
 </div>
 </div>
 </div>
