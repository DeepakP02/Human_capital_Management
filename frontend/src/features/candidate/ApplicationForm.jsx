...
const ApplicationForm = () => {
 ...
 <p className="text-slate-400 font-medium tracking-tight uppercase text-sm">Phased submission for <span className="text-slate-900 dark:text-white font-medium">{jobInfo.title}</span></p>
 </div>
 </div>
 </div>
 ...
 <div className="relative">
 <Phone className="absolute left-5 top-4 text-slate-300 group-focus-within:text-primary-500 transition-colors" size={18} />
 <input type="tel" value={formData.phone} onChange={e => setFormData({...formData, phone: e.target.value})} required className="input-field pl-14 h-12 font-medium" />
 </div>
 </div>
 <div className="space-y-3 group text-left">
 ...
 <section className="space-y-10">
  ...
  <div className="relative">
  <DollarSign className="absolute left-5 top-4 text-slate-300 group-focus-within:text-primary-500 transition-colors" size={18} />
  <input type="text" value={formData.expectedSalary} onChange={e => setFormData({...formData, expectedSalary: e.target.value})} placeholder="$145,000" className="input-field pl-14 h-12 font-medium" />
  </div>
  </div>
  </div>
  </section>
