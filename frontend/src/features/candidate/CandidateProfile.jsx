...
const CandidateProfile = () => {
 ...
 {isEditing && (
 <label className="absolute inset-0 bg-primary-600/40 flex items-center justify-center cursor-pointer transition-opacity">
 ...
 <p className="text-sm font-bold text-slate-900"> {profile.fullName.split(' ')[0]}_Resume_Final.pdf </p>
 <p className="text-xs font-medium text-slate-400 mt-1">Updated recently • 4.2 MB</p>
 </div>
 </div>
 <div className="flex items-center gap-3">
 <button className="w-12 h-12 bg-white text-slate-400 hover:text-primary-600 rounded-xl flex items-center justify-center transition-all shadow-sm border border-slate-100">
 <Download size={20} />
 </button>
 <button className="w-12 h-12 bg-white text-slate-400 hover:text-rose-500 rounded-xl flex items-center justify-center transition-all shadow-sm border border-slate-100">
 <Trash2 size={20} />
 </button>
 </div>
 </div>
 ...
 <div className="w-16 h-16 bg-white rounded-xl flex items-center justify-center text-slate-200 group-hover:text-primary-600 transition-colors shadow-inner">
 <FileText size={28} />
 </div>
 <div className="text-left">
 <p className="text-sm font-medium text-slate-900 uppercase tracking-tight">{doc.name}</p>
