...
const BrowseJobs = () => {
 ...
 showToast(`Application for ${selectedJob.title} sent!`);
  ...
  className="input-field pl-12 h-14 bg-slate-50 dark:bg-slate-950 border-transparent font-medium"
  value={searchTerm}
  ...
  <select 
  className="input-field pl-12 h-14 bg-slate-50 dark:bg-slate-950 border-transparent font-medium appearance-none cursor-pointer"
