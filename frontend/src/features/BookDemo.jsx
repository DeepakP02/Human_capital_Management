...
const BookDemo = () => {
  ...
  const handleFormSubmit = (e) => {
    ...
    setTimeout(() => {
      // Save demo request submission in simulated local database
      const existing = localStorage.getItem('hcm_demo_requests');
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            {[
              ...
              <motion.div
                key={i}
                whileHover={{ y: -5 }}
                className="bg-white rounded-3xl border border-slate-100 dark:border-slate-800 p-6 flex flex-col justify-between shadow-soft hover:shadow-premium transition-all"
              >
                <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 relative z-10">
              ...
              <div className="lg:col-span-4 space-y-6">
                ...
                <div className="p-6 bg-white/5 backdrop-blur-md rounded-3xl border border-white/10 text-left">
                  ...
                  <StatsCounter target={96.8} label="Average Attendance" suffix="%" />
                </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
                    <div className="p-4 bg-white/5 border border-white/10 rounded-2xl">
                      <StatsCounter target={412.5} label="Total Disbursed" prefix="$" suffix="k" />
                    </div>
                    <div className="p-4 bg-white/5 border border-white/10 rounded-2xl">
                      <StatsCounter target={84.2} label="Taxes & Contributions" prefix="$" suffix="k" />
                    </div>
                    <div className="p-4 bg-white/5 border border-white/10 rounded-2xl">
                      <StatsCounter target={12.4} label="Wellness Budget" prefix="$" suffix="k" />
                    </div>
                  </div>
