         ...
         {selectedMember && (
            <div className="flex flex-col h-full overflow-hidden">
               ...
               <div className="p-5 sm:p-6 border-b border-slate-100 flex flex-col md:flex-row items-center gap-6 bg-slate-50/50">
                  ...
                  <div className="text-center md:text-left flex-1">
                     ...
                     <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 mt-3">
                        ...
                        <div className="flex items-center gap-1.5 text-slate-500">
                           <Phone size={14} /> <span className="text-xs sm:text-sm font-bold">{selectedMember.phone || '+1 555-0123'}</span>
                        </div>
                        <div className="flex items-center gap-1.5 text-slate-500">
                        ...
                        <motion.div key="summary" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="space-y-8 text-left">
                           <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-left">
                              ...
                              <div className="p-4 sm:p-5 bg-slate-50 rounded-2xl border border-slate-100 flex flex-col justify-center items-center">
                                 ...
                                 <span className="text-2xl font-black text-slate-900">12 / 15</span>
                              </div>
                              <div className="p-4 sm:p-5 bg-slate-50 rounded-2xl border border-slate-100 flex flex-col justify-center items-center">
                           ...
                           <div className="card p-4 sm:p-5 bg-slate-900 border-none shadow-lg text-white relative overflow-hidden flex flex-col justify-center">
                              <div className="flex items-center justify-between relative z-10">
                                 <div>
                                    ...
                                    <h4 className="text-2xl font-black tracking-tight">98.5% Efficiency</h4>
                                 </div>
                             ...
                             <div key={i} className="p-4 bg-slate-50 rounded-xl border border-slate-100 hover:border-slate-200 transition-all group">
                                <div className="flex items-center justify-between mb-2 text-left">
                                   <div className="text-left">
                                      ...
                                      <p className="text-[9px] font-bold text-slate-400 mt-0.5 uppercase tracking-widest">Due {task.due} • {task.priority} Priority</p>
                                   </div>
                     ...
                     {profileTab === 'kpi' && (
                        <motion.div key="kpi" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="space-y-6 text-left">
                           <div className="p-4 sm:p-5 bg-indigo-50 border border-indigo-100 rounded-2xl text-center">
                              ...
                              <p className="text-xs font-bold text-indigo-600 uppercase tracking-widest">Calculated across 8 core metrics</p>
                           </div>
                           <div className="space-y-4">
                              {[
                     ...
                     {profileTab === 'notes' && (
                       <motion.div key="notes" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="space-y-6 text-left">
                          ...
                          <div className="flex justify-end">
                            <button className="btn-primary px-4 py-2 font-bold text-xs uppercase tracking-widest">Post Internal Note</button>
                          </div>
                          <div className="space-y-3 pt-3 border-t border-slate-50">
                             <div className="p-3 bg-slate-50 rounded-xl text-left italic relative group">
                                ...
                                <p className="text-[9px] font-black text-slate-400 mt-1.5 uppercase tracking-widest">— Michael Scott, Oct 12</p>
                             </div>
                          </div>
                       </motion.div>
                     )}
               ...
               <div className="p-4 sm:p-6 border-t border-slate-100 bg-slate-50 flex flex-col sm:flex-row gap-3 shrink-0">
                  <button className="flex-1 py-2.5 sm:py-3 bg-white border border-slate-200 text-slate-600 rounded-xl font-bold hover:bg-slate-100 transition-all flex items-center justify-center gap-2 text-xs sm:text-sm">
                     <Target size={16} />
                     <span>Assign New Goal</span>
                  </button>
                  <button className="flex-1 py-2.5 sm:py-3 bg-primary-600 text-white rounded-xl font-bold hover:bg-primary-700 transition-all shadow-lg flex items-center justify-center gap-2 text-xs sm:text-sm">
                     <BarChart3 size={16} />
